...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KEYWORD_IN = 4,                 /* KEYWORD_IN  */
  YYSYMBOL_KEYWORD_CONSTRAINT = 5,         /* KEYWORD_CONSTRAINT  */
  ...
  YYSYMBOL_constraint_def = 19,            /* constraint_def  */
...
static const char *const yytname[] =
{
  ...
  "KEYWORD_IN", "KEYWORD_CONSTRAINT", "ASSIGN", "SEMICOLON", "ID", "INT",
  "OPERATOR", "'['", "'.'", "']'", "$accept", "program", "statements",
  "statement", "var_decl", "constraint_def", "assignment", YY_NULLPTR
};
...
{
       1,    10,     2,    11,    12,     3,    13,    15,    23,    16,
      17,    18,    19,     0,    20,    26,    22,    21,    14,    27,
      25,     0,    24
};

static const yytype_int8 yycheck[] =
{
       3,     8,     5,     8,     6,     8,     0,     4,    12,    10,
       9,    11,     8,    -1,     7,    13,     7,     9,     5,     7,
       9,    -1,    12
};
...
{
       0,     3,     5,     8,    15,    16,    17,    18,    19,    20,
       8,     8,     6,     0,    17,     4,    10,     9,    11,     8,
       7,     9,     7,    12,    12,     9,    13,     7
};
...
#line 48 "src/parser.y"
           { 
               ...
               if ((yyvsp[0].node_val) != nullptr) {
                   astRoot->addChild((Node*)(yyvsp[0].node_val)); 
               }
           }
#line 1127 "src/parser.cpp"
    break;
...
#line 1144 "src/parser.cpp"
  ...
  case 6: /* statement: constraint_def  */
...
#line 1156 "src/parser.cpp"
  ...
  case 8: /* var_decl: KEYWORD_VAR ID KEYWORD_IN '[' INT '.' '.' INT ']' SEMICOLON  */
#line 70 "src/parser.y"
         {
             // 1. Build AST Node
             (yyval.node_val) = (void*)(new VarDeclNode((yyvsp[-8].str_val), (yyvsp[-5].int_val), (yyvsp[-2].int_val)));
...
#line 1168 "src/parser.cpp"
  ...
  case 9: /* constraint_def: KEYWORD_CONSTRAINT ID OPERATOR ID SEMICOLON  */
#line 81 "src/parser.y"
               {
                   // 1. Logic Trigger: Add rule to logic engine
                   logicEngine.addRule((yyvsp[-3].str_val), (yyvsp[-2].str_val), (yyvsp[-1].str_val));
                   
                   // 2. Build AST Node
                   (yyval.node_val) = (void*)(new ConstraintNode((yyvsp[-3].str_val), (yyvsp[-2].str_val), (yyvsp[-1].str_val)));
...
#line 1183 "src/parser.cpp"
  ...
  case 10: /* assignment: ID ASSIGN INT SEMICOLON  */
#line 95 "src/parser.y"
           {
               // 1. Validate the move against constraints
               if (!logicEngine.isMoveValid((yyvsp[-3].str_val), (yyvsp[-1].int_val), symbolTable)) {
               ...
               symbolTable.setValue((yyvsp[-3].str_val), (yyvsp[-1].int_val));
               
               // 3. Build AST Node
               (yyval.node_val) = (void*)(new AssignmentNode((yyvsp[-3].str_val), (yyvsp[-1].int_val)));
